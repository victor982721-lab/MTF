# Borrador no enviado — confirmación Pepperstone/cTrader Open API

**Asunto:** Consulta de elegibilidad y uso de cTrader Open API en cuenta DEMO

Hola,

Utilizo una integración local de investigación con una cuenta DEMO existente y cTrader Open API, exclusivamente con permiso de consulta `accounts`. La aplicación ya está activa y la lectura autenticada fue comprobada. Agradeceré confirmar por escrito:

1. La entidad Pepperstone y las condiciones contractuales aplicables a un residente de México con esta modalidad DEMO.
2. El tipo de cuenta, símbolos y condiciones de cTrader disponibles, así como las diferencias relevantes entre DEMO y LIVE.
