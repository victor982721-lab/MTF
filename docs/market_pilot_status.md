...
manifiesto activo conserva el run `20260917T182831Z-cf0c76e1`, en
`state=ACTIVE_RUNTIME`/`promotion_state=ACTIVE`, y su SHA-256 es
`6e73dcd2180a764c906f28698c5274d5d60131ab040ca036993262d73b88bebc`.
El receipt vigente de promoción es
`runtime/verification/runtime-lifecycle-final4-promote-20260917.json`; su hash
...
está en `runtime/market-evidence/runtime-lifecycle-final-verification-20260917-v5.json`;
la focal del lifecycle es
`runtime/market-evidence/runtime-lifecycle-focused-tests-final-v3-20260917.json`.
