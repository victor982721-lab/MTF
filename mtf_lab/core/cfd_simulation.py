...
from .cfd_quote_contract import (
    CFDQuote,
    CFDSimulationError,
    QuoteAssessment,  # noqa: F401 - historical module-level compatibility name
    QuoteLeg,  # noqa: F401 - historical module-level compatibility name
    QuoteQuality,
    QuoteReason,
    QuoteSide,
    _bool,
    ...
    _jsonable,
    _utc,
    assess_pair,  # noqa: F401 - historical module-level compatibility name
    decimal,
    quality_from,
    quality_reasons_from,  # noqa: F401 - historical module-level compatibility name
)
from .numeric import (
...
# The canonical implementation moved, but the historical module remains the
# public identity for compatibility with repr/pickle and old import paths.
CFDQuote.__module__ = __name__
CFDSimulationError.__module__ = __name__
