...
from ..core.aggregation import interval_start
...
from .processor_checkpoint import (
    _decision_id,
    _engine_state,
    _indicator_point_dict,
    _indicator_point_from_dict,
    _restore_engine_state,
    _restore_shared_aggregator,
    checkpoint_json,
    checkpoint_snapshot,
    restore_checkpoint,
...
from .processor_checkpoint import (
    _strategy_checkpoint_data as checkpoint_strategy_data,
)
from .state import (
    PendingSimulation,
    PriceObservation,
...
class IncrementalProcessor:
    ...
    def _strategy_checkpoint_data(self) -> dict[str, Any]:
        return checkpoint_strategy_data(self)

    def _strategy_checkpoint_payload(self) -> dict[str, Any]:
        return strategy_checkpoint_payload(
            self,
            config_hash=_processor_config_hash,
            extra_config=_processor_extra_config,
        )
